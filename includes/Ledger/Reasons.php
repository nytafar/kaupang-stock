 ...
 *
 *  - OWNED   (adjust/receipt/count/reversal): the operation originates in this
 *    plugin. The ledger records first, then writes through to WooCommerce
 *    (active mode only) and advances the balances.last_written_id watermark.
...
final class Reasons {
    ...
    public static function owned(): array {
        return [self::RECEIPT, self::COUNT, self::ADJUST, self::REVERSAL];
    }
